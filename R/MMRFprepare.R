...
MMRFprepare <- function(query,
  ...
  object<-TCGAbiolinks::GDCprepare(query,
                                   save,
                                   save.filename,
                                   directory,
  ...
  definition<-SummarizedExperiment::colData(object)$sample_type
  definition <- as.data.frame(definition)
  SummarizedExperiment::colData(object) <- cbind(SummarizedExperiment::colData(object), definition)
